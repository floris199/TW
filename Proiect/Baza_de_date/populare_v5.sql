...
DROP TABLE tutori cascade constraints;
DROP TABLE copii;
...
create table intrebari(
  ...
  raspuns varchar2(100),
  varianta_raspuns_1 varchar2(100),
  varianta_raspuns_2 varchar2(100),
  varianta_raspuns_3 varchar2(100),
...
BEGIN
    ...
    LOOP
        FETCH lista_studenti INTO v_std_linie; 
            ...
            insert into copii(parola,nume,nume_cont,cheie,locked) values (dbms_random.string('U', 20),v_std_linie.name,v_nume_cont,v_cheie,0);
            j := j + 1;
...
insert into tutori (id,email,parola,nume) values (51,'floris','floris','floris');
insert into legaturi (copil_id,tutore_id) values (1,51);
insert into legaturi (copil_id,tutore_id) values (2,51);
insert into legaturi (copil_id,tutore_id) values (3,51);

UPDATE tutori
SET nume = 'Alfred Schmidt';

UPDATE copii SET locked = 0 WHERE nume = 'Alexandra Citea';